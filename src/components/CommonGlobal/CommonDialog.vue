<template>
  <div class="dialog-container">
    <div class="container" :class="{fadeIn: fadeIn ? true: false}" :style="!maxHeight ? 'max-height:none': ''">
      <div class="header">
      ...
      <div class="footer">
        <el-button class="bn-button cancel" :class="optionInit.delete ? 'cancel-delete': ''"
          :style="{width: optionInit.width, height: optionInit.height}"
          @click="close"
        >{{optionInit.cancel}}</el-button>
        <el-button class="bn-button is-active" :class="{'delete': optionInit.delete, 'conformDisabled': confirmDisabled}"
          @click="confirm"
